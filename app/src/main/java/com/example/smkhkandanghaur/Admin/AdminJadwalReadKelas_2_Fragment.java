 ...
 */
public class AdminJadwalReadKelas_2_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_admin_jadwal_read_kelas_2_, container, false);
        ...
        databaseReference = firebaseDatabase.getReference().child("smkh").child("pelajaran").child("kelas_2");
    ...
    private void JadwalPelajaranKelas() {
        FirebaseRecyclerAdapter<Jadwal, AdminJadwalReadKelas_2_Fragment.JadwalViewHolder> jadwal
                = new FirebaseRecyclerAdapter<Jadwal, AdminJadwalReadKelas_2_Fragment.JadwalViewHolder>
                (Jadwal.class, R.layout.fragment_admin_jadwal_read_kelas_2_recyclerview,
                        AdminJadwalReadKelas_2_Fragment.JadwalViewHolder.class, databaseReference) {
            @Override
            protected void populateViewHolder(AdminJadwalReadKelas_2_Fragment.JadwalViewHolder viewHolder, Jadwal model, int position) {
