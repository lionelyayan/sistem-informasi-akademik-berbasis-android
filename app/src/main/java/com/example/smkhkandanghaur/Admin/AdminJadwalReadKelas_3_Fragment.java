 ...
 */
public class AdminJadwalReadKelas_3_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_admin_jadwal_read_kelas_3_, container, false);
        ...
        databaseReference = firebaseDatabase.getReference().child("smkh").child("pelajaran").child("kelas_3");
    ...
    private void JadwalPelajaranKelas() {
        FirebaseRecyclerAdapter<Jadwal, AdminJadwalReadKelas_3_Fragment.JadwalViewHolder> jadwal
                = new FirebaseRecyclerAdapter<Jadwal, AdminJadwalReadKelas_3_Fragment.JadwalViewHolder>
                (Jadwal.class, R.layout.fragment_admin_jadwal_read_kelas_3_recyclerview,
                        AdminJadwalReadKelas_3_Fragment.JadwalViewHolder.class, databaseReference) {
            @Override
            protected void populateViewHolder(AdminJadwalReadKelas_3_Fragment.JadwalViewHolder viewHolder, Jadwal model, int position) {
